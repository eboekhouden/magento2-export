...
class Creditmemo extends \Magento\Sales\Controller\Adminhtml\Order\AbstractMassAction
{
    ...
    protected function massAction(AbstractCollection $collection)
    {
        ...
        foreach ($collection->getItems() as $creditmemo) {
     	...
     	list($iAdded, $iExist, $sErrorMsg, $sInfoMsg) = $response = $this->_eHelper->exportCreditmemo($creditmemoIds);
